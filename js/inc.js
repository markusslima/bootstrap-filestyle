$(document).ready(function () {
	var menuHTML = '<nav class="navbar navbar-dark bg-primary fixed-top navbar-expand-lg" role="navigation">'
				 ...
				 + '			          	More plugins <span class="badge badge-primary">New plugins</span>' 
				 + '			        </a>'
				 ...
				 + '					    <a class="dropdown-item" target="_blank" href="http://markusslima.github.io/bird-alert/">Bird Alert <span class="badge badge-primary">New</span></a>'
